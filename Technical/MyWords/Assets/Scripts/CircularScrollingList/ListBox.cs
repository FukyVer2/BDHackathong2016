...
public class ListBox : MonoBehaviour
{
	...
	public Text textContent;		// The content of the list box
    public Image imageContent;
    public BaseCategory baseCategory; //The content
    ...
    void updateContent(BaseCategory _baseCategory)
    {
        this.baseCategory = _baseCategory;
        this.textContent.text = _baseCategory.categoryContent;
        this.imageContent.sprite = ResourceLoader.GetCategorySprite(_baseCategory.categoryPhoto.Trim());
    }
    ...
    void updateContent()
    {
        if ((int)transform.position.y == (int)ListPositionCtrl.Instance.centerPosY)
        {
