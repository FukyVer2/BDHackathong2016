...
using System;
public class ScrollbarCtr : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    {
        float absPoz = Mathf.Abs(_screensContainer.gameObject.GetComponent<RectTransform>().offsetMin.x);
