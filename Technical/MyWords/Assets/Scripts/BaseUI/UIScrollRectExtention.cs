...
public class UIScrollRectExtention : UIBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement
{
    ...
    protected UIScrollRectExtention()
	{}
	...
	public void OnEndDrag(PointerEventData eventData)
	{
		...
		m_Dragging = false;
        //
        UIGridLayout.Instance.ResizeOfParent();
	}
	...
	public void OnDrag(PointerEventData eventData)
	{
		...
		m_Content.anchoredPosition = position;
        //
        UIGridLayout.Instance.ScaleChildOnDrag();
	}
